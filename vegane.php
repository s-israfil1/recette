...
<body class="body_vegane">
    ...
    <main>
        <section class="section_cat1">
            ...
            <div class="title_cat">
                <h2>Recettes Végane</h2>
            </div>
            <div class="txt_cat1">
                <p>
                    🌱 <span>B</span>ienvenue dans l'univers des délices véganes ! 🌿
                </p>
            </div>
            <div class="txt_cat2">
                <p>
                    Nous sommes ravis de vous accueillir dans notre section dédiée aux recettes véganes, 
                    où la créativité et la santé se rencontrent. Que vous soyez un passionné de cuisine 
                    végétale ou simplement curieux d'explorer de nouvelles saveurs, vous êtes au bon endroit !
                </p>
            </div>
        </section>
        <section class="section_cat2">
            <div class="boite_cat">
                <?php foreach (getRecipes($veganerecipes) as $recipe) : ?>

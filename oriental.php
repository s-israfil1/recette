...
<body class="body_cat">
    ...
    <main>
        <section class="section_cat1">
            ...
            <div class="title_cat">
                <h2>Recettes Orientale</h2>
            </div>
            <div class="txt_cat1">
                <p>
                    <span>B</span>ienvenue dans le monde des recettes orientales ! ✨
                </p>
            </div>
            <div class="txt_cat2">
                <p>
                    Nous sommes enchantés de vous accueillir dans notre section dédiée aux saveurs envoûtantes de l'Orient. 
                    Que vous soyez un passionné de cuisine ou simplement curieux de découvrir de nouvelles saveurs, vous 
                    êtes au bon endroit !
                </p>
            </div>
        </section>
